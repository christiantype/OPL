...
(function () {
  ...
  const menuMark = `<span class="nav-asterisk" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10.5" stroke="currentColor" stroke-width="1.5"/><circle cx="12" cy="7.4" r="1.35" fill="currentColor"/><path d="M12 10.7v6.3" stroke="currentColor" stroke-width="2.1" stroke-linecap="round"/></svg></span>`;
