...
(function idleWords() {
  ...
  const WORDS = [
    ...
    'Subtract until it breaks, then step back once.',
    'The mistake is the material.',
    'Teach it to learn it.',
    'Slow down until it gets interesting.',
    'Trust the first mark.',
    'What is the work avoiding?',
    'Make the invisible thing louder.',
    'Repeat it until it becomes strange.',
    'Honor the rough draft.',
    'Follow the warmth.',
